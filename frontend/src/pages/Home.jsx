                                ...
                                <div key={index} className="feature-card">
                                    {feature.image?.url ? (
                                        <div className="feature-icon">
                                            <img src={feature.image.url} alt={feature.title} style={{ width: '64px', height: '64px', objectFit: 'cover', borderRadius: '12px' }} />
                                        </div>
                                    ) : (
                ...
                <div className="container">
                    ...
                    {productsLoading ? (
                        ...
                        <div className="products-grid" style={{
                            ...
                            {(!featuredProducts?.data?.data?.products || featuredProducts?.data?.data?.products.length === 0) && (
                                <div className="no-products">No featured products found.</div>
                            )}
                            {featuredProducts?.data?.data?.products?.length > 0 &&
                                featuredProducts.data.data.products.length < featuredProductsCount && (
                                    <div style={{ gridColumn: '1/-1', textAlign: 'center', color: '#718096', fontSize: '0.9rem', marginTop: '10px' }}>
                    ...
                    <div className="container">
                        <div className="cta-card">
                            <div className="cta-content">
                                <h2 className="cta-title">{theme?.cta?.title || 'Begin Your Glow Journey'}</h2>
                                <p className="cta-description">
                                    {theme?.cta?.description || 'Join thousands who\'ve discovered their perfect skincare routine. Natural beauty starts here.'}
                                </p>
                                <Link to={theme?.cta?.buttonLink || '/products'} className="btn btn-primary btn-lg">
                                    {theme?.cta?.buttonText || 'Shop Collection'}
                                    <ArrowRight size={20} />
                                </Link>
                            </div>
