                    ...
                    <div className="admin-form-group">
                        ...
                        <div style={{ display: 'grid', gap: 'var(--space-4)', marginBottom: 'var(--space-4)' }}>
                            {colorVariants.map((variant, index) => (
                                <div key={index} className="theme-item-box" style={{ padding: 'var(--space-4)', border: '1px solid #eee', borderRadius: 'var(--radius-md)' }}>
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr auto', gap: 'var(--space-3)', alignItems: 'center' }}>
                                        <div>
                                            <label style={{ fontSize: '12px', display: 'block', marginBottom: '4px' }}>Name</label>
                                            <input
                                                type="text"
                                                value={variant.name}
                                        ...
                                        <div>
                                            <label style={{ fontSize: '12px', display: 'block', marginBottom: '4px' }}>Mapped Image</label>
                                            <select
                                    ...
                                    {variant.imageUrl && (
                                        <div style={{ marginTop: '10px' }}>
                                            <img src={variant.imageUrl} alt="Mapped" style={{ width: '40px', height: '40px', objectFit: 'cover', borderRadius: '4px' }} />
                                        </div>
                                    )}
                                </div>
                            ))}
                        </div>
                        <button type="button" className="btn btn-outline btn-sm" onClick={addColorVariant}>
                            + Add Color Variant
                        </button>
                    </div>
