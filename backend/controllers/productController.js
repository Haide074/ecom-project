...
export const getProductByIdOrSlug = asyncHandler(async (req, res) => {
    ...
    if (identifier.match(/^[0-9a-fA-F]{24}$/)) {
        ...
        product = await Product.findOne({ slug: identifier, isDeleted: false }).populate(
            'category',
            'name slug'
        );
    }
...
export const createProduct = asyncHandler(async (req, res) => {
    ...
    if (typeof productData.colorVariants === 'string' && productData.colorVariants.startsWith('[')) {
...
export const updateProduct = asyncHandler(async (req, res) => {
    ...
    if (typeof req.body.colorVariants === 'string' && req.body.colorVariants.startsWith('[')) {
